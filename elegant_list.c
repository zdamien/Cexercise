...
// copied and modified code, trying to sparse elegance
...
node* get_parent(node* list, int data) {
    // workhorse function to get the *parent* of a node with value.
    // Assumes a list with header.
